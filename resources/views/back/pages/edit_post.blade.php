                ...
                <div class="card card-box mb-2">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Entre com o titulo do post" value=" {{ $post->title }}">
                            <span class="text-danger error-text title_error"></span>
                        </div>
                        <div class="form-group">
                            <label for=""><b>Conteúdo</b>:</label>
                            <textarea name="contents" id="editor" cols="30" rows="10" class="ckeditor form-control" placeholder="Entre com o conteudo do post..."> {!! $post->contents !!}</textarea>
                ...
                <div class="card card-box mb-2">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="meta_keywords" placeholder="Entre com as keywords" value=" {{ $post->meta_keywords }}">
                        </div>
                        <div class="form-group">
                            <label for=""><b>Descricao do meta do post</b></label>
                            <textarea name="meta_description" id="" cols="30" rows="10" class="form-control" placeholder="Entre com a descrição...">{{ $post->meta_description}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
